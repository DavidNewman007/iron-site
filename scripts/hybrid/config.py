...
# Добавлен 18.09.2026: лист завели 15.09, а сюда не прописали, и конвейер
# карточек новых айфонов просто не видел — в магазине они висели плитками без
# фотографии. Ровно та же история, что с Prices-3 в августе. Проверяя новый
# склад, смотри не только прайс и бота, но и этот список.
SHEET_TABS = ["Prices", "Prices-2", "Prices-3", "Prices-4"]
...
# Характеристики, чей КЛЮЧ выбрасывается по шаблону. Пока здесь одно правило —
# гарантия (28.08.2026).
#
# У поставщика в таблице стоит «Срок гарантии: 12 месяцев» — это ЕГО условия, а
# не наши. У нас гарантия своя и другая: базовая 7 дней либо до активации,
# год — отдельной платной услугой за 2000₽. Строка из чужой таблицы обещала
# клиенту год бесплатно и прямо противоречила тому, что написано в плитке
# товара и в карточке бота. Владелец, увидев её в боте: «нужно проверить все
# карточки и удалить эту информацию про гарантию».
#
# Ловим по подстроке, а не точным ключом «Срок гарантии»: у поставщика
# встречаются и «Гарантия», и «Гарантия производителя», и они появляются в
# новых категориях без предупреждения. Полезной характеристики со словом
# «гарантия» у техники не бывает — терять нечего.
SPEC_DROP_KEY_PATTERNS = [re.compile(r"гарант|warrant", re.I)]
