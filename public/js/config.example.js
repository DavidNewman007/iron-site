...
window.IRON_CONFIG = {
   ...
   *
   * Кнопка включается ОДНИМ этим значением. Пока пусто — кнопки нет ни в
   * корзине магазина, ни на карточках товаров. Заполнять, когда будет доступ
   * к личному кабинету интернет-эквайринга Альфа-Банка и функция alfa-pay
   * заработает в тестовой среде. Порядок — в docs/ALFA-PAY-SETUP.md
